...
export default function AttendanceReportPage() {
  ...
  function removeProjectEmp(empId: string) { setProjectEmps(prev => prev.filter(e => e.empId !== empId)) }
              ...
              {tab === 'project' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  {projectEmps.length > 0 && (
                    <div>
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
                        <label style={{ fontSize: 12, fontWeight: 600, color: C.muted, textTransform: 'uppercase', letterSpacing: '0.06em' }}>Employees ({projectEmps.length})</label>

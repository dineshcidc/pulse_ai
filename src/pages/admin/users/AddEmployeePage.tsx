...
import {
  ...
  Building2, BookOpen, FileSpreadsheet, UploadCloud, Download, X,
} from 'lucide-react'
...
export default function AddEmployeePage() {
  ...
  function handleSuccessDone() {
    ...
    setEmpType(''); setEmpStatus(''); setDesignation(''); setLevel(''); setDepartment('')
    setManager(''); setOfficeLocation(''); setWorkLocation(''); setWorkNature('')
    setJoinDate(''); setConfirmDate(''); setNoticePeriod(''); setShift('')
    setAttendanceRec(''); setCalendar(''); setDeskNumber(''); setJobDesc('')
    setRole(''); setProject('')
    setActiveTab(1)
  }

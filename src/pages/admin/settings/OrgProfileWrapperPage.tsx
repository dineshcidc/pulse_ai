...
function SectionCard({ icon: Icon, title, sub, accent, accentBg, gridArea, children }: {
  icon: React.ElementType; title: string; sub: string
  accent: string; accentBg: string; gridArea?: string; children: React.ReactNode
}) {
  return (
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 13.5, color: C.muted, margin: 0 }}>Fill in your organisation's details to complete the setup</p>
      </div>
      ...
      <div style={{
        ...
        <div style={{ gridArea: 'offices', background: '#fff', border: `1px solid ${C.border}`, borderRadius: 18, overflow: 'hidden' }}>
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 13.5, color: C.muted, margin: 0 }}>Setting up your company profile…</p>
      </div>
      <div style={{ background: '#fff', border: `1px solid ${C.border}`, borderRadius: 20, padding: '80px 40px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 13.5, color: C.muted }}>Please wait while we set up your organisation</div>
        </div>

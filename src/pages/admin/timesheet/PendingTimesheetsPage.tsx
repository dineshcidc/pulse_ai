    ...
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div style={{ background:'#fff', border:`1px solid ${C.border}`, borderRadius: hasEmpFilter ? '16px 16px 0 0' : '16px', padding:'14px 20px', marginBottom:0 }}>
        <div style={{ display:'flex', alignItems:'center', gap:12 }}>
          ...
          {/* Generate button — far right, disabled until employee filter selected */}
          <button
            ...
            {state === 'loading'
              ? <><div style={{ width:15, height:15, borderRadius:'50%', border:'2.5px solid rgba(255,255,255,0.3)', borderTopColor:'#fff', animation:'pt-spin 0.75s linear infinite' }} /> Loading…</>

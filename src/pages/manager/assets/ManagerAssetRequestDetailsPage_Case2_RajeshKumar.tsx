...
export default function ManagerAssetRequestDetailsPage_Case2({ onNavigate }: ManagerAssetRequestDetailsPageProps) {
  const mockRequest = {
    id: 'ar-002',
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ background: '#F9FAFB', padding: 20, borderRadius: 12, display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 20 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 13, fontWeight: 600, color: C.navy }}>Need Dell Monitor for Rajesh Kumar for urgent work</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ background: 'rgba(245,158,11,0.08)', padding: 24, borderRadius: 12, border: '2px solid rgba(245,158,11,0.24)', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: 80 }}>
                <div style={{ textAlign: 'center' }}>
                  ...
                  <div style={{ fontSize: 12, color: '#B45309', opacity: 0.8 }}>{mockRequest.employeeName} has not yet accepted this request</div>
                </div>
              </div>
            </div>
          </div>

...
/* Health statuses shown (read-only) on the Risks & Issues card. */
...
/* Dummy: derive the submitted health status from the project's health. */
const STATUS_BY_HEALTH: Record<string, string> = { Healthy: 'On Track', 'At Risk': 'At Risk', Delayed: 'Critical / Off Track' }
...
export default function ReportViewPage({
  ...
  const selectedStatus = STATUS_BY_HEALTH[project.health] ?? 'At Risk'

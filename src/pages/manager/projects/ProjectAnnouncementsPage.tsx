    ...
    <div style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <div className="flex items-start justify-between mb-5">
        ...
        <button onClick={() => setView('compose')}
          style={{ height: 40, padding: '0 18px', borderRadius: 11, border: 'none', background: '#1C2035', color: '#fff', fontSize: 13.5, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit', display: 'flex', alignItems: 'center', gap: 7, transition: 'background 0.15s', flexShrink: 0 }}
